...
export default function CreateNews(props) {
    return <div class="grid grid-cols-1 w-full">
        <div class="flex  font-serif text-justify  justify-between  col-span-1  p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="">
                <Link to="/signup" class="content-center my-1 w-fit inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4: focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Create an Admin
                </Link>
            </div>
            <div class="">
